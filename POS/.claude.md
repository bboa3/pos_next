# Claude Code Rules for POS MZ

This file contains project-specific rules and conventions for Claude Code when working on the POS MZ application.
...
<<<<<<< HEAD
*Project: POS MZ - Modern POS System for ERPNext*
=======
