...
export default defineConfig({
	plugins: [
		...
		VitePWA({
			...
			includeAssets: ["favicon.png", "favicon.ico", "icon.svg", "icon-maskable.svg", "logo.svg"],
			manifest: {
				name: "POS MZ",
				short_name: "POS MZ",
				description:
					"MozEconomia Cloud POS with real-time billing, stock management, and offline support",
				theme_color: "#02664D",
				...
				icons: [
					{
						src: "/assets/pos_next/pos/favicon.png",
						sizes: "180x180",
						type: "image/png",
						purpose: "any",
					},
