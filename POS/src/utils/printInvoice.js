 ...
 * @note Use "POS MZ Receipt" format for thermal printer (80mm) or configure via POS Profile
 */
export async function printInvoice(
	...
	try {
		...
		const format = printFormat || "POS MZ Receipt"
	...
	const printContent = `
		...
		<body>
			<div class="receipt">
				<!-- Header -->
				<div class="header">
					<div class="company-name">${invoiceData.company || "POS MZ"}</div>
			...
			: ""
				...
				<div class="footer">
					...
					<div style="font-size: 10px;">Powered by <a href="https://mozeconomia.co.mz" target="_blank" style="color: #3b82f6; text-decoration: none; font-weight: 600;">MozEconomia Cloud</a></div>
				</div>
			</div>
